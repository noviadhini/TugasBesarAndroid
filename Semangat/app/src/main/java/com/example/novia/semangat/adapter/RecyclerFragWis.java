...
import com.example.novia.semangat.TwoFragment;
import com.example.novia.semangat.model.ImageUploadInfoWis;

import java.util.List;

/**
 * Created by TOSHIBA-97 on 1/29/2018.
 */

public class RecyclerFragWis extends RecyclerView.Adapter<RecyclerFragWis.ViewHolder> {

    Context context;
    List<ImageUploadInfoWis> MainImageUploadInfoListWis;

    public RecyclerFragWis(Context context, List<ImageUploadInfoWis> TempList) {
    ...
    @Override
    public void onBindViewHolder(RecyclerFragWis.ViewHolder holder, int position) {
    ...
    public void openDetailActivity(String...details){
        Intent i = new Intent(context, TwoFragment.class);
